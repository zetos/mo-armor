import type { SupportMaterial, DefenseStats, ArmorStyle } from '../types';
...
/**
 * Padding material configurations per armor style.
 * Some padding materials behave differently in different armor styles.
 * Each material + style combination defines:
